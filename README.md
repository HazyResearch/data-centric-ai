...
The large quantities of available biological data have necessitated the creation of methods to prune irrelevant features and integrate knowledge across datasets in order to extract relevant biological signal. 
